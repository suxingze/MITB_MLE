...
# --------------------------------
# Gold Label Data Store Check
# --------------------------------
print("Checking Gold Label Data Store...")
gold_label_store_directory = os.path.join(data_dir, "gold", "label_store")
if not os.path.exists(gold_label_store_directory):
    print(f"Gold Label Data Store '{gold_label_store_directory}' does not exist. Please check the data source.")
    raise SystemExit("Exiting the program due to missing gold label data store.")
print(f"Gold Label Data Store '{gold_label_store_directory}' exists.")

print("Gold label data store checks passed successfully.")